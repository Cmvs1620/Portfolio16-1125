...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://linkedin.com/carl-maurits-von-schantz", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://instagram.com/mauritsvonschantz", label: "Instagram" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "Maurits.vonschantz@gmail.com", href: "mailto:Maurits.vonschantz@gmail.com" },
    { icon: <Phone size={16} />, text: "+46701484910", href: "tel:+46701484910" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">CMVS</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Digital designer creating meaningful experiences.
              </p>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <form className="space-y-3">
                <input 
                  type="email" 
                  placeholder="maurits.vonschantz@gmail.com" 
          ...
          >
            <div>
              <p>© {currentYear} CMVS. All rights reserved.</p>
            </div>
