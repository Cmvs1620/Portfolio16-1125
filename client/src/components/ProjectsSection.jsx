...
const projects = [
...

  {
    ...
    image: "/projects/Givenchy/amalia.png",
    gallery: [
      "/projects/Givenchy/amalia.png",
      "/projects/Givenchy/cowboy.png",
      "/projects/Givenchy/bunny.png",
      "/projects/Givenchy/jeans.png",
      "/projects/Givenchy/shoe.png",
...
This experience taught me to navigate a high-pressure work environment while maintaining creative integrity. I honed my technical skills, improved my communication, and learned valuable lessons in time management and resilience. Overall, my time at Corniche significantly contributed to my professional growth in graphic design and marketing.`,
    ...
    tags: ["Watchworld"],
    image: "/corniche/cornichecover.png",
    gallery: [
      "/corniche/cornichecover.png",
      "/corniche/1.png",
      "/corniche/website.png",
      "/corniche/box.jpg",
      "/corniche/insta1.png",
      "/corniche/sides.png",
      "/corniche/story.png",
