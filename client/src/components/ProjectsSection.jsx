...
const projects = [
  // ====== PAF ======
  {
    ...
    gallery: [
      ...
      "/projects/paf/atp.png",
      "/projects/paf/gonz.png"
    ],
...

  {
    ...
    image: "/public/projects/Givenchy/amalia.png",
    gallery: [
      "/public/projects/Givenchy/amalia.png",
      "/public/projects/Givenchy/cowboy.png",
      "/public/projects/Givenchy/bunny.png",
      "/public/projects/Givenchy/jeans.png",
      "/public/projects/Givenchy/shoe.png",
      "/projects/Givenchy/giv1.png",
      "/projects/Givenchy/giv1.png",
      "/projects/Givenchy/giv2.jpg",
      "/projects/Givenchy/giv3.jpg",
      "/projects/Givenchy/Test.gif",
    ],
...
The well-spaced letters create a clear and balanced readability, while the minimalist style with rounded forms adds a modern touch. The logo serves both as a distinctive mark and an icon, practical for various uses. It reflects our restaurant's fusion of Asian and Mexican street food and appeals to a wide audience seeking a unique dining experience.`,
    ...
    image: "/projects/yono/bag.png",
    gallery: [
      "/projects/yono/bag.png",
      "/projects/yono/Burito.png",
      "/projects/yono/chart.png",
      "/projects/yono/shirt.png",
      "/projects/yono/Stickers.png",
      "/projects/yono/YONO.gif",
      "/projects/yono/OTTO.png",
      "/projects/yono/meny.png",
      "/projects/yono/chair.png",
    ],
...
The challenge was to make the brand look fresh and clear through its packaging and advertising designs. Project Design ApproachI chose a minimalist and practical design style for Lundi. The brand is all about straightforward skincare solutions, so it was important that the design reflected this. The packaging needed to be simple yet elegant, showing how effective the product is without any fuss.Using natural textures like crumpled paper and rock formations in their visuals, I played with the contrast between the ruggedness of nature and the smooth, clean lines of their bottles. It's a nod to use of natural ingredients without getting lost in the typical "green" aesthetic.`,
    ...
    image: "/public/Lundi/gras.png",
    gallery: [
      "/public/Lundi/gras.jpg",
      "/public/Lundi/creme.png",
      "/public/Lundi/rocks.png",
      "/public/Lundi/creme.png",
      "/public/Lundi/stock.jpg",
      "/public/Lundi/melbaba.png",
      "/public/Lundi/stock.png",
      "/public/Lundi/babapapper.jpg",
    ],
...
This experience taught me to navigate a high-pressure work environment while maintaining creative integrity. I honed my technical skills, improved my communication, and learned valuable lessons in time management and resilience. Overall, my time at Corniche significantly contributed to my professional growth in graphic design and marketing.`,
    ...
    tags: ["Watchworld"],
    image: "/public/corniche/cornichecover.png",
    gallery: [
      "/public/corniche/cornichecover.png",
      "/public/corniche/1.png",
      "/public/corniche/website.png",
      "/public/corniche/box.jpg",
      "/public/corniche/insta1.png",
      "/public/corniche/sides.png",
      "/public/corniche/story.png",
      "/public/corniche/insta4.png",
    ],
  ...
  },
  {
    ...
    image: "/public/betula/Sign2.png",
    gallery: [
      "/public/betula/graphical.gif",
      "/public/betula/cover.png",
      "/public/betula/LOGO.png",
      "/public/betula/open1.png",
      "/public/betula/Sign2.png",
    ],
  ...
  },
  {
    ...
    image: "/public/dank/Red1.jpg",
    gallery: [
      "/public/dank/glas.gif",
      "/public/dank/fest.png",
      "/public/dank/Red1.jpg",
      "/public/dank/tshirt.png",
      "/public/dank/blom.png"
    ],
  ...
  },
  {
    ...
    tags: ["Next.js", "Figma"],
    image: "/public/Zuru/gal.png",
    gallery: [
      "/public/Zuru/p-1.png",
      "/public/Zuru/p-2.png",
      "/public/Zuru/p-3.png",
      "/public/Zuru/p-4.png",
      "/public/Zuru/p-12.png",
      "/public/Zuru/ipad1.png",
      "/public/Zuru/ipad2.png",
    ],
